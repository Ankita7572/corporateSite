      ...
      <div className="desc">
        ...
        >
          <ul className="skill-list">
            <li>
              Knowledge of ASP.NET for web development and MVC
            ...
            <li>
              Knowledge of client-side libraries and frameworks such as jQuery,
              Angular, or React.
            </li>
            <li>Knowledge of code deployment process or a tool like Git</li>
            <li>
              Experience with Continuous Integration (CI) and Continuous
              Deployment (CD) processes.
            </li>
