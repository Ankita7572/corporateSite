      ...
      <div className="desc">
        ...
        >
          <ul className="skill-list">
            <li>
              Experinced in al least on MVC Framework, preferre Yii 1/2, Cake
              PHP framework
            </li>
            ...
            <li>
              Knowledge of threading mechanisms, background processing, and
              handling concurrency using AsyncTask, Handlers, Threads,
              Executors, or Kotlin Coroutines.
            </li>
            <li>Knowledge of code deployment process or a tool like Git</li>
            <li>
              Understanding of Android security practices, encryption, secure
              data storage, and best practices to protect user data and app
              integrity.
            </li>
            <li>Capability to handle issue tracking and version management</li>
            <li>Workking Knowledge of Linux will be an added advantage</li>
          </ul>
        </div>
